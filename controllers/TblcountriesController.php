...
/**
 * TblcountriesController implements the CRUD actions for Tblcountries model.
 */
class TblcountriesController extends Controller
{
    ...
    /**
     * Displays a single Tblcountries model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new Tblcountries model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new Tblcountries();
    ...
    /**
     * Updates an existing Tblcountries model.
    ...
    /**
     * Deletes an existing Tblcountries model.
